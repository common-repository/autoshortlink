...
if( strlen(get_option('asl_api_key'))!=32 ) {
  add_action( 'admin_notices', 'asl_notice' );
}
function asl_notice()
{
?>
  <div class="update-nag notice">
      <p><?php _e( 'Configure Your Shorte.st API key <a href="options-general.php?page=autoshortlink">Here</a>'); ?></p>
  </div>
<?php
}
